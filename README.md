...
- [Estrutura dos exemplos](#structure-of-the-examples)
- [Como usar](#usage)
- [👀 Exemplos](#-examples)
  - [Sessão: Abra a sua mente!](#section-strain-your-brain)
    - [▶ Strings podem ser complicadas, às vezes *](#-strings-can-be-tricky-sometimes-)
    - [▶ Pausa para alguns hashs magicos!](#-time-for-some-hash-brownies)
    - [▶ Retorne o Retorno em tudo!](#-return-return-everywhere)
    - [▶ No fundo, somos todos iguais. *](#-deep-down-were-all-the-same-)
    - [▶ Pra que?](#-for-what)
    - [▶ Avaliando diferença de tempo](#-evaluation-time-discrepancy)
    - [▶ `is` não é is!](#-is-is-not-what-it-is)
    - [▶ Um jogo da velha em que o X sempre ganha de primeira!](#-a-tic-tac-toe-where-x-wins-in-the-first-attempt)
    - [▶ A saida visguenta de função](#-the-sticky-output-function)
    - [▶ `is not ...` não é `is (not ...)`](#-is-not--is-not-is-not-)
    - [▶ A virgula extraordinária](#-the-surprising-comma)
    - [▶ Barras invertidas no final da string](#-backslashes-at-the-end-of-string)
    - [▶ not knot!](#-not-knot)
    - [▶ Strings Meio-triplicadas](#-half-triple-quoted-strings)
    - [▶ Meia-noite não existe?](#-midnight-time-doesnt-exist)
    - [▶ O que há de errado com os booleanos?](#-whats-wrong-with-booleans)
    - [▶ Atributos de classe e atributos de instância](#-class-attributes-and-instance-attributes)
    - [▶ yielding None](#-yielding-none)
    - [▶ Mutação do imutável!](#-mutating-the-immutable)
    - [▶ A variável desaparecendo do escopo externo](#-the-disappearing-variable-from-outer-scope)
    - [▶ Quando True é realmente falso](#-when-true-is-actually-false)
    - [▶ De preenchido para None em uma instrução ...](#-from-filled-to-none-in-one-instruction)
